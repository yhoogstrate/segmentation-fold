...
void test_vij(Zuker &zuker)
{
	...
	p = {1, 17};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.60f), "V(1,17) = " + std::to_string(e));
	...
	p = {2, 16};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.70f), "V(2,16) = " + std::to_string(e));
	p = {2, 17};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.20f), "V(2,17) = " + std::to_string(e));
...
void test_wij(Zuker &zuker)
{
	...
	p = {0, 14};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.00f), "W(0,14) = " + std::to_string(e));
	p = {0, 15};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.50f), "W(0,15) = " + std::to_string(e));
	p = {0, 16};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.50f), "W(0,16) = " + std::to_string(e));
	p = {0, 17};
	e = zuker.wij.get(p);
	...
	p = {1, 14};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.00f), "W(1,14) = " + std::to_string(e));
	p = {1, 15};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.50f), "W(1,15) = " + std::to_string(e));
	p = {1, 16};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.50f), "W(1,16) = " + std::to_string(e));
	p = {1, 17};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.70f), "W(1,17) = " + std::to_string(e));
	...
	p = {2, 14};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.00f), "W(2,14) = " + std::to_string(e));
	p = {2, 15};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.50f), "W(2,15) = " + std::to_string(e));
	p = {2, 16};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.50f), "W(2,16) = " + std::to_string(e));
	p = {2, 17};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.70f), "W(2,17) = " + std::to_string(e));
