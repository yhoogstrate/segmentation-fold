...
void test_vij(Zuker &zuker)
{
	...
	p = {0, 4};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(0,4) = " + std::to_string(e));
	p = {0, 5};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(0,5) = " + std::to_string(e));
	p = {0, 6};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(0,6) = " + std::to_string(e));
	p = {0, 7};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(0,7) = " + std::to_string(e));
	p = {0, 8};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(0,8) = " + std::to_string(e));
	p = {0, 9};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(0,9) = " + std::to_string(e));
	p = {0, 10};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(0,10) = " + std::to_string(e));
	p = {0, 11};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(0,11) = " + std::to_string(e));
	p = {0, 12};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 4.20f), "V(0,12) = " + std::to_string(e));
	p = {0, 13};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.80f), "V(0,13) = " + std::to_string(e));
	p = {0, 14};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -1.30f), "V(0,14) = " + std::to_string(e));
	p = {0, 15};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -1.60f), "V(0,15) = " + std::to_string(e));
	p = {0, 16};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -1.70f), "V(0,16) = " + std::to_string(e));
	p = {0, 17};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -5.40f), "V(0,17) = " + std::to_string(e));
	...
	p = {1, 5};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(1,5) = " + std::to_string(e));
	p = {1, 6};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(1,6) = " + std::to_string(e));
	p = {1, 7};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(1,7) = " + std::to_string(e));
	p = {1, 8};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(1,8) = " + std::to_string(e));
	p = {1, 9};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(1,9) = " + std::to_string(e));
	p = {1, 10};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(1,10) = " + std::to_string(e));
	p = {1, 11};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(1,11) = " + std::to_string(e));
	p = {1, 12};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 4.10f), "V(1,12) = " + std::to_string(e));
	p = {1, 13};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 2.00f), "V(1,13) = " + std::to_string(e));
	p = {1, 14};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 1.70f), "V(1,14) = " + std::to_string(e));
	p = {1, 15};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 1.60f), "V(1,15) = " + std::to_string(e));
	p = {1, 16};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.10f), "V(1,16) = " + std::to_string(e));
	p = {1, 17};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -3.60f), "V(1,17) = " + std::to_string(e));
	...
	p = {2, 6};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(2,6) = " + std::to_string(e));
	p = {2, 7};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(2,7) = " + std::to_string(e));
	p = {2, 8};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(2,8) = " + std::to_string(e));
	p = {2, 9};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(2,9) = " + std::to_string(e));
	p = {2, 10};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(2,10) = " + std::to_string(e));
	p = {2, 11};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(2,11) = " + std::to_string(e));
	p = {2, 12};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 5.30f), "V(2,12) = " + std::to_string(e));
	p = {2, 13};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 5.00f), "V(2,13) = " + std::to_string(e));
	p = {2, 14};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 4.90f), "V(2,14) = " + std::to_string(e));
	p = {2, 15};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 1.20f), "V(2,15) = " + std::to_string(e));
	p = {2, 16};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -0.30f), "V(2,16) = " + std::to_string(e));
	p = {2, 17};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -0.80f), "V(2,17) = " + std::to_string(e));
	...
	p = {3, 7};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(3,7) = " + std::to_string(e));
	p = {3, 8};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(3,8) = " + std::to_string(e));
	p = {3, 9};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(3,9) = " + std::to_string(e));
	p = {3, 10};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(3,10) = " + std::to_string(e));
	p = {3, 11};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(3,11) = " + std::to_string(e));
	p = {3, 12};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(3,12) = " + std::to_string(e));
	p = {3, 13};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(3,13) = " + std::to_string(e));
	p = {3, 14};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(3,14) = " + std::to_string(e));
	p = {3, 15};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(3,15) = " + std::to_string(e));
	p = {3, 16};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(3,16) = " + std::to_string(e));
	p = {3, 17};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(3,17) = " + std::to_string(e));
	...
	p = {4, 8};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(4,8) = " + std::to_string(e));
	p = {4, 9};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(4,9) = " + std::to_string(e));
	p = {4, 10};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(4,10) = " + std::to_string(e));
	p = {4, 11};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(4,11) = " + std::to_string(e));
	p = {4, 12};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(4,12) = " + std::to_string(e));
	p = {4, 13};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(4,13) = " + std::to_string(e));
	p = {4, 14};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(4,14) = " + std::to_string(e));
	p = {4, 15};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(4,15) = " + std::to_string(e));
	p = {4, 16};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(4,16) = " + std::to_string(e));
	p = {4, 17};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(4,17) = " + std::to_string(e));
	...
	p = {5, 9};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(5,9) = " + std::to_string(e));
	p = {5, 10};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(5,10) = " + std::to_string(e));
	p = {5, 11};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(5,11) = " + std::to_string(e));
	p = {5, 12};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(5,12) = " + std::to_string(e));
	p = {5, 13};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(5,13) = " + std::to_string(e));
	p = {5, 14};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(5,14) = " + std::to_string(e));
	p = {5, 15};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(5,15) = " + std::to_string(e));
	p = {5, 16};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(5,16) = " + std::to_string(e));
	p = {5, 17};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(5,17) = " + std::to_string(e));
	...
	p = {6, 10};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(6,10) = " + std::to_string(e));
	p = {6, 11};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(6,11) = " + std::to_string(e));
	p = {6, 12};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 3.20f), "V(6,12) = " + std::to_string(e));
	p = {6, 13};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 2.50f), "V(6,13) = " + std::to_string(e));
	p = {6, 14};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.00f), "V(6,14) = " + std::to_string(e));
	p = {6, 15};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.50f), "V(6,15) = " + std::to_string(e));
	p = {6, 16};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.50f), "V(6,16) = " + std::to_string(e));
	p = {6, 17};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.70f), "V(6,17) = " + std::to_string(e));
	...
	p = {7, 11};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(7,11) = " + std::to_string(e));
	p = {7, 12};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 6.20f), "V(7,12) = " + std::to_string(e));
	p = {7, 13};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 1.30f), "V(7,13) = " + std::to_string(e));
	p = {7, 14};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.80f), "V(7,14) = " + std::to_string(e));
	p = {7, 15};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.80f), "V(7,15) = " + std::to_string(e));
	p = {7, 16};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.60f), "V(7,16) = " + std::to_string(e));
	p = {7, 17};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 1.10f), "V(7,17) = " + std::to_string(e));
	...
	p = {8, 13};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 4.10f), "V(8,13) = " + std::to_string(e));
	p = {8, 14};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 4.10f), "V(8,14) = " + std::to_string(e));
	p = {8, 15};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 3.90f), "V(8,15) = " + std::to_string(e));
	p = {8, 16};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 4.40f), "V(8,16) = " + std::to_string(e));
	p = {8, 17};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 4.10f), "V(8,17) = " + std::to_string(e));
	...
	p = {9, 13};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(9,13) = " + std::to_string(e));
	p = {9, 14};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(9,14) = " + std::to_string(e));
	p = {9, 15};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(9,15) = " + std::to_string(e));
	p = {9, 16};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(9,16) = " + std::to_string(e));
	p = {9, 17};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(9,17) = " + std::to_string(e));
	...
	p = {10, 14};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(10,14) = " + std::to_string(e));
	p = {10, 15};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(10,15) = " + std::to_string(e));
	p = {10, 16};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(10,16) = " + std::to_string(e));
	p = {10, 17};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(10,17) = " + std::to_string(e));
	...
	p = {11, 15};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(11,15) = " + std::to_string(e));
	p = {11, 16};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(11,16) = " + std::to_string(e));
	p = {11, 17};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(11,17) = " + std::to_string(e));
	...
	p = {12, 16};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(12,16) = " + std::to_string(e));
	p = {12, 17};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(12,17) = " + std::to_string(e));
	...
	p = {13, 17};
	e = zuker.vij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, N_INFINITY), "V(13,17) = " + std::to_string(e));
...
void test_wij(Zuker &zuker)
{
	...
	p = {0, 13};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.00f), "W(0,13) = " + std::to_string(e));
	p = {0, 14};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -1.30f), "W(0,14) = " + std::to_string(e));
	p = {0, 15};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -1.60f), "W(0,15) = " + std::to_string(e));
	p = {0, 16};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -1.70f), "W(0,16) = " + std::to_string(e));
	p = {0, 17};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -5.40f), "W(0,17) = " + std::to_string(e));
	...
	p = {1, 13};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.00f), "W(1,13) = " + std::to_string(e));
	p = {1, 14};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.00f), "W(1,14) = " + std::to_string(e));
	p = {1, 15};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.00f), "W(1,15) = " + std::to_string(e));
	p = {1, 16};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.10f), "W(1,16) = " + std::to_string(e));
	p = {1, 17};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -3.60f), "W(1,17) = " + std::to_string(e));
	...
	p = {2, 14};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.00f), "W(2,14) = " + std::to_string(e));
	p = {2, 15};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.00f), "W(2,15) = " + std::to_string(e));
	p = {2, 16};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -0.30f), "W(2,16) = " + std::to_string(e));
	p = {2, 17};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -0.80f), "W(2,17) = " + std::to_string(e));
	...
	p = {3, 13};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.00f), "W(3,13) = " + std::to_string(e));
	p = {3, 14};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.00f), "W(3,14) = " + std::to_string(e));
	p = {3, 15};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.50f), "W(3,15) = " + std::to_string(e));
	p = {3, 16};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.50f), "W(3,16) = " + std::to_string(e));
	p = {3, 17};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.70f), "W(3,17) = " + std::to_string(e));
	...
	p = {4, 13};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.00f), "W(4,13) = " + std::to_string(e));
	p = {4, 14};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.00f), "W(4,14) = " + std::to_string(e));
	p = {4, 15};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.50f), "W(4,15) = " + std::to_string(e));
	p = {4, 16};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.50f), "W(4,16) = " + std::to_string(e));
	p = {4, 17};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.70f), "W(4,17) = " + std::to_string(e));
	...
	p = {5, 13};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.00f), "W(5,13) = " + std::to_string(e));
	p = {5, 14};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.00f), "W(5,14) = " + std::to_string(e));
	p = {5, 15};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.50f), "W(5,15) = " + std::to_string(e));
	p = {5, 16};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.50f), "W(5,16) = " + std::to_string(e));
	p = {5, 17};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.70f), "W(5,17) = " + std::to_string(e));
	...
	p = {6, 13};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.00f), "W(6,13) = " + std::to_string(e));
	p = {6, 14};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.00f), "W(6,14) = " + std::to_string(e));
	p = {6, 15};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.50f), "W(6,15) = " + std::to_string(e));
	p = {6, 16};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.50f), "W(6,16) = " + std::to_string(e));
	p = {6, 17};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, -2.70f), "W(6,17) = " + std::to_string(e));
	...
	p = {7, 14};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.00f), "W(7,14) = " + std::to_string(e));
	p = {7, 15};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.00f), "W(7,15) = " + std::to_string(e));
	p = {7, 16};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.00f), "W(7,16) = " + std::to_string(e));
	p = {7, 17};
	e = zuker.wij.get(p);
	BOOST_CHECK_MESSAGE(IdenticalFloats(e, 0.00f), "W(7,17) = " + std::to_string(e));
	...
	for(unsigned char i = 0 ; i < 10; i++)
	{
		...
		for(unsigned int x = 0;  x < (unsigned int) sequence.size(); x++)
		{
			for(unsigned int y = x;  y < (unsigned int) sequence.size(); y++)
			{
				...
				{
					printf("	p = {%i, %i};t = zuker.tij_v.get(p);BOOST_CHECK_EQUAL(t.store_pair, %s);BOOST_CHECK_EQUAL(t.target.first, UNBOUND);\n", x,  y, t.store_pair ? "true" : "false");
				}
				else
				{
					printf("	p = {%i, %i};t = zuker.tij_v.get(p);BOOST_CHECK_EQUAL(t.store_pair, %s);BOOST_CHECK_EQUAL(t.target.first, %i);BOOST_CHECK_EQUAL(t.target.second, %i);\n", x,  y, t.store_pair ? "true" : "false", t.target.first, t.target.second);
				}
			}
			printf("\n");
		}
